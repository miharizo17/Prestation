<%-- 
    Document   : listeLogistique
    Created on : Jun 19, 2023, 5:40:18 PM
    Author     : Kanto
--%>
...
<% ArrayList<V_logistique> listLogistique = (ArrayList<V_logistique>) request.getAttribute("listLogistique");
 ArrayList<Typelogistique> listType = (ArrayList<Typelogistique>) request.getAttribute("listType");
%>
<jsp:include page='header.jsp'/>
<title>ListeLogistique</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12 mx-auto">
                <div class="section-title-wrap mb-5">
                    <h4 class="section-title">Liste des logistiques</h4>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <table class="table">
                ...
                <tr>
                    <td><%= listLogistique.get(i).getType()%></td>
                    <td><%= listLogistique.get(i).getTarif()%></td>
                    <td><a href="deleteArtiste?id=<%= listLogistique.get(i).getId()%>">Supprimer</a></td>
                    <td><a href="formModifArtiste?idModif=<%= listLogistique.get(i).getId()%>">Modifier</a></td>
                </tr>
                <%}%>
            </table>
        </div>
